...
- Per piani che toccano tool MCP, prompt framework o codice engine, usa le istruzioni locali disponibili nel pacchetto base e il contesto reale del workspace.
